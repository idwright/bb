...
for SOURCE in vobs genre spotmalaria vivax
    #vw_vrpipe sanger_ega_dataset pf_6_metadata pv_3_sanger_source_code_metadata pv_3_broad_metadata pv_3_broad_sra_accessions pv_3_locations pv_3_chapellhill_sra_accessions pv_3_sanger_source_code_metadata_test
do
